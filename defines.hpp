...
#define TRT // choose two-relaxation-time LBM collision operator; mucho mas estable que SRT cuando el tau esta pegado a 0.5 (nuestro caso: aire real con Re muy alto sobre una grilla de unos pocos metros -> tau queda cerca del limite de estabilidad)
